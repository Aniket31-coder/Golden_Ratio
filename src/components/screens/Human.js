    ...
    <div>
      <div className="Human-paras">
        ...
        <div className="Human-content">
          ...
          <div>
            <p>
              ...
              The mouth and nose are each placed at golden sections of the
          ...
          <div style={{ height: "240px" }}>
            ...
            <p>
              ...
              Divine Proportion. The first golden section (blue) from the front
              of the head defines the position of the ear opening. The
              successive golden sections define the neck (yellow), the back of
              the eye (green) and the front of the eye and back of the nose and
              mouth (magenta). The dimensions of the face from top to bottom
              also exhibit the Divine Proportion, in the positions of the eye
              brow (blue), nose (yellow) and mouth (green and magenta).
            </p>
          </div>
        </div>
        <div className="handAndFoot">
          ...
          <p>
            Let’s start with something simple. Take your hand off your keyboard
            or mouse and look at the proportions of your index finger.
          </p>
